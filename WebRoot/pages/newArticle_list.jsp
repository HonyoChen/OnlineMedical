		...
		<div class="container">
			...
			<div class="menu-top-menu-container">
				<ul id="menu-top-menu" class="clearfix">
					...
					<li class="current-menu-item"><a href="<%=path%>/pages/newArticle_list.jsp">文章列表</a></li>
...
var data;
	...
	function search() {	     
	//alert("进入research()");
	$("#newArticlesList").html="";
	 var dep = document.getElementById("s").value;
     $.ajax({
			...
			//alert(JSON.stringify(result)); 
				$("#newArticlesList").html="";	
			//	window.open("selectNewArticle_list.jsp?id="+dep.toString(),"_top"); 			
			/*    window.location.href="selectNewArticle_list.jsp?id="+dep.toString(); */
