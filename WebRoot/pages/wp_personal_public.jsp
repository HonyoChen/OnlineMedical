...
<script type="text/javascript">
	...
	function showFile(obj){
		...
		if(obj.isDirectory == 1){
			...
			html += "<a class=\"aa\" href='javascript:;' onclick='pushStack(" + JSON.stringify(obj) + ")'><input id=\"input_"+ obj.fid +"\"  maxlength=\"40\" type=\"text\" disabled=\"disabled\" style=\"font-size:14px;BACKGROUND-COLOR: transparent;border-style:none\" value=\"&nbsp;&nbsp;" + obj.filename +"\" ></input></a>";	
		}else{
			...
			html += "<input id=\"input_"+ obj.fid +"\"  type=\"text\" disabled=\"disabled\" style=\"width: 70%;font-size:14px;BACKGROUND-COLOR:transparent;border-style:none\" value=\"&nbsp;&nbsp;" + obj.filename +"\"></input>";
			}
		html += "<a href='javascript:;' onclick='sharedOrCancleShared("+ obj.fid +")' title=\"设为私密\"><i style=\"float:right;padding:8px;\" class=\"fa fa-lock\" aria-hidden=\"true\"></i></a>";
		...
		html += "<a href='javascript:;' onclick='moveFolder(" + obj.fid +")' title=\"移动到\"><i style=\"float:right;padding:8px;\" class=\"fa fa-random\" aria-hidden=\"true\"></i></a>";
	...
	function moveFolder(fid){
		...
		var params = 'fid=' + fid +"&rid=" + stack.bottom().fid + "&did=" + <%= user.getUid() %>;
		var encodeData = window.btoa(params);
		var url='changeFolder.jsp?' + encodeData;//转向网页的地址;
	...
	function createFolder(){
		...
		var html = "";
		html += "<tr>";
		html += "<td width=\"30\" ><li class=\"checkbox\"><input type=\"checkbox\" maxlength=\"30\" name=\"chose\" onclick=\"checkListen();\" /></li></td>";
		html += "<td>";
		html += "<span class=\"fa fa-folder-open fa-2x\" aria-hidden=\"true\"></span>";
	...
	<div class="yp-content">
		...
		<div class="location">
			<div class="yp-location" id="position">
				当前位置：<a href="wp_home.jsp">数据管理</a> > <a href=\"wp_personal.jsp?type=2\">共享文件</a>
			</div>
			...
			<table class="table table-hover">
				<thead id="tthead">
					<tr style="height:30px">
						<th>
							<li class="checkbox"><input type="checkbox" id="all"
